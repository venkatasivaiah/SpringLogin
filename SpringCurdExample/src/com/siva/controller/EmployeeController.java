...
import com.siva.bean.EmployeeBean;
import com.siva.model.Employee;
import com.siva.service.EmployeeService;
...
public class EmployeeController {
	...
	public ModelAndView listEmployees() {
		logger.info("Inside get Employees method");
	...
	public ModelAndView deleteEmployee(@ModelAttribute("command")  EmployeeBean employeeBean,
			BindingResult result) {
		logger.info("Inside Edit Employee method");
		Map<String, Object> model = new HashMap<String, Object>();
